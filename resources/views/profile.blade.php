    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    @if (!Auth::guest())
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('story2') }}" enctype="multipart/form-data" >
                        {{ csrf_field() }}
                        @if (count($errors) > 0)
                        ...
                        <div class="form-group{{ $errors->has('story_body') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="story_body" name="story_body" cols="50" rows="2" class="form-control" required>{{ old('story_body') }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('image_caption') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="image_caption" type="text" class="form-control" name="image_caption" required>
